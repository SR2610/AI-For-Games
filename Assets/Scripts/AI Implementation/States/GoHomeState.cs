...
public class GoHomeState : State<AI>
{
    ...
    public override void UpdateState(AI owner)
    {
        ...
        if (owner.GetAgentData().HasEnemyFlag || owner.GetAgentData().HasFriendlyFlag) //If they have the flag, they should be checking if they are back at their base
        {
            ...
            owner.StateMachine.ChangeState(GotoEnemyBaseState.Instance); //Fallthrough to near default state
